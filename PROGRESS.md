...
**Status:** 🟢 Wave C complete; Wave D in progress — D1 + D2 + D3 released as **0.75.0** (api · mcp · engines; dagster `0.75.0-dagster`), frontend D1–D3 in `bifrost-trade-frontend` (`53c617a`, Satellite chain). D3 acceptance waits on the Owner's L0 (trust matrix still L1) and one unattended day. Next: D4 verdict chips. Plan: `docs/plans/RESEARCH_LOOP_AUTOMATION_PLAN.md`. D10 BLOCKED.
