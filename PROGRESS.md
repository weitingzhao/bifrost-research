...
**Status:** 🟢 Wave B in progress — B1 + B2 + B3 on DEV as package **0.70.0** (api · mcp · engines · dagster `0.70.0-dagster`), frontend B2 + B3 in `bifrost-trade-frontend` (Satellite chain) (api · mcp · dagster `0.68.0-dagster`, 2026-09-06). Plan: `docs/plans/RESEARCH_LOOP_AUTOMATION_PLAN.md`. D10 BLOCKED.
